(function() {
    ...
    BitStream.prototype.protobuf = function(collector) {
    ...
    BitStream.prototype.vChunk = function() {
        ...
        clone.limit = clone.index + size;
        this.index += size;
        return clone;
    }

    BitStream.prototype.clone = function() {
        var clone = new BitStream(this.buffer);
    ...
    Entity.prototype.isPlayer = function() {
        return this.classInfo.dataTableName == 'DT_CSPlayer';
    }

    Entity.prototype.isWeapon = function() {
        return this.classInfo.dataTableName.substr(0, 9) == 'DT_Weapon';
    }

    Entity.prototype.isDecoyGrenade = function() {
        return this.classInfo.dataTableName == 'DT_DecoyGrenade';
    }

    Entity.prototype.isHEGrenade = function() {
        return this.classInfo.dataTableName == 'DT_HEGrenade';
    }

    Entity.prototype.isSmokeGrenade = function() {
        return this.classInfo.dataTableName == 'DT_SmokeGrenade';
    }

    Entity.prototype.isFlashbang = function() {
        return this.classInfo.dataTableName == 'DT_Flashbang';
    }
    ...
    Entity.prototype.getAimPunchAngle = function() {
    ...
    Entity.prototype.getArmorValue = function() {
        return this.getValue('m_ArmorValue') || 0;
    }

    Entity.prototype.isSpotted = function() {
    ...
    inherits(JSGO, EventEmitter);

    JSGO.prototype.parse = function(buffer) {

        var stream = new BitStream(buffer),
            cmd, serverInfo, running = true;
        ...
        while (running) {
            ...
            this.emit('server_command', header);
    ...
    JSGO.prototype.parseStringTables = function(stream) {
        ...
        for (var i = 0; i < numTables; i++) {
            ...
            for (var j = 0; j < numStrings; j++) {
                ...
                if (stream.bits(1)) {
                    ...
                    if (isUserTable) {
                        console.log('dataSize = ' + userDataSize);
                    }
    ...
    JSGO.prototype.readPlayer = function(stream) {
        stream.skip(16);
        var player = {
    ...
    JSGO.prototype.parsePacket = function(stream) {
        stream.skip(160);
    ...
    JSGO.prototype.handlePacketEntities = function(message) {
    ...
    JSGO.prototype.addEntity = function(entityId, classInfo, serialNumber) {
        var entity = this.findEntityById(entityId);
        if (entity == null) {
    ...
    JSGO.prototype.removeEntity = function(entityId) {
    ...
    JSGO.prototype.handleGameEventsList = function(message) {
    ...
    JSGO.prototype.handleGameEvent = function(message) {
        ...
        if (this.gameEventDescriptors[message.eventId] != null) {
            ...
            switch (description.name) {
                ...
                case 'player_disconnect':
                    var player = this.findPlayerById(params.userid);
                    params = {
    ...
    JSGO.prototype.parseProtobufMessage = function(stream) {
    ...
    JSGO.prototype.parseStringTableUpdate = function(stream, numEntries, maxEntries, userDataSize, userDataSizeBits, userDataFixedSize) {

        console.log('parse string table update');
        ...
        for (var i = 0; i < numEntries; i++) {
            ...
            if (size > 0) {
                console.log('num bits read = ' + (stream.tellBits() - bitDebug));
            }
        }
    }

    JSGO.prototype.gatherProps = function(serverClass, dataTable, excludes, path) {
        var tmp = [];
    ...
    JSGO.prototype.iterateProps = function(serverClass, dataTable, props, excludes, path) {
    ...
    JSGO.prototype.gatherExcludes = function(dataTable, excludes) {
    ...
    JSGO.prototype.findDataTable = function(name) {
    ...
    JSGO.prototype.isPropExcluded = function(dataTable, prop, excludes) {
    ...
    JSGO.prototype.sortProps = function(flattened) {
        var priorities = [];
        priorities.push(64);
    ...
    JSGO.prototype.parseDataTables = function(stream) {
    ...
    JSGO.prototype.addPlayer = function(player, index) {
    ...
    JSGO.prototype.findPlayerById = function(userId) {
    ...
    JSGO.prototype.findPlayerIndex = function(userId) {
    ...
    JSGO.prototype.findEntityByPlayerId = function(userId) {
        var index = this.findPlayerIndex(userId);
        if (index > -1) {
    ...
    JSGO.prototype.findEntityById = function(entityId) {
    ...
    JSGO.prototype.findPlayerByEntityId = function(entityId) {
        return this.players[entityId - 1];
    }

    JSGO.prototype.findPlayerByEntity = function(entity) {
        return this.players[entity.entityId - 1];
    }


    JSGO.prototype.findEntityByPlayer = function(player) {
        return this.findEntityByPlayerId(player.userId);
    }
